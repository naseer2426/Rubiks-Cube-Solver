...
def solution_instructions():
    print('''Hold the rubik's cube such that the white centre piece is facing you and the blue centre piece is on top. Everytime you make a move, revert back to holding the cube in this position

Instructions to moves:

U - Face the Upper layer and turn it Clockwise (Anti-Clockwise if U')
D - Face the Lower layer and turn it Clockwise (Anti-Clockwise if D')
L - Face the Left layer and turn it Clockwise (Anti-Clockwise if L')
R - Face the Right layer and turn it Clockwise (Anti-Clockwise if R')
F - Face the Front layer and turn it Clockwise (Anti-Clockwise if F')
B - Face the Back layer and turn it Clockwise (Anti-Clockwise if B')''')
    print()
...
O-Orange''')
    print()
    #Blue Face
    print("Hold the rubik's cube such that the Blue centre piece is facing you and the Yellow centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
            p=input("Please input a correct colour: ")
        side.append(p)
    cube.append(side)
    #White face
    print("Hold the rubik's cube such that the white centre piece is facing you and the blue centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
    ...
    cube.append(side)
    #Red face
    print("Hold the rubik's cube such that the red centre piece is facing you and the blue centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
    ...
    cube.append(side)
    #Yellow face
    print("Hold the rubik's cube such that the yellow centre piece is facing you and the blue centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
    ...
    cube.append(side)
    #Orange face
    print("Hold the rubik's cube such that the orange centre piece is facing you and the blue centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
    ...
    cube.append(side)
    #Green Face
    print("Hold the rubik's cube such that the Green centre piece is facing you and the White centre piece is on top. Input the pieces from top left to bottom right:")
    side=[]
    for i in range(9):
        p=input(str(i+1)+':')
        while p.lower() not in ['w','b','r','g','y','o']:
